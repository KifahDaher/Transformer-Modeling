...
di1 = @(t,i1)((1/L11)*(sqrt(2)*110*cos(2*pi*60*t)-r1*i1)); % declaring FUNODE to solve differential equation using ODE
...
title('TRANSFORMER MODELING - SHORT CIRCUIT [ v1=sqrt(2)110cos(377t) ]')
xlabel('time (s)')
ylabel('v1 (V)')
grid on
